<?php
   ...
   if($_SESSION["acces"]!='y')
   {
        ...
        $arrayConsultation = $Util -> getListConsultation($Id_Medecin);
   }
                        ...
                        <div class="Left-body">
                            ...
                            <div class="infos">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th colspan="1">Id Consultation</th>
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($arrayConsultation); $i++) {
                                            $Consultation = $arrayConsultation[$i];
                                            $Id_Consultation = $Consultation->getId_Consultation();
                                            $Date_Consultation = $Consultation->getDate_Consultation();
                                            $Compte_Rendu_Consultation = $Consultation->getCompte_Rendu_Consultation();
                                            $Id_Patient = $Consultation->getId_Patient();

                                            echo "<tr><td>" . $Id_Consultation . "</td>";
                                            echo "<td>" . $Date_Consultation . "</td>";
                                            echo "<td>" . $Compte_Rendu_Consultation . "</td>";
