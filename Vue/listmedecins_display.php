<?php
    ...
    if ($_SESSION["acces"] != 'y') {
        ...
        $arrayMedecin = $Util -> getListMedecin();
    }
                        ...
                        <div class="infos">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($arrayMedecin); $i++) {
                                        $Medecin = $arrayMedecin[$i];
                                        $Id_Medecin = $Medecin->getId_Medecin();
                                        $Nom_Medecin = $Medecin->getNom_Medecin();
                                        $Prenom_Medecin = $Medecin->getPrenom_Medecin();
                                        echo "<tr><td>" . $Id_Medecin . "</td>";
                                        echo "<td>" . $Nom_Medecin . "</td>";
                                        echo "<td>" . $Prenom_Medecin . "</td>";
                                    }
                                    ?>
                                </tbody>
                            </table>
                    ...
                    <div class="Right-body">
                        <div class="About-us">
                            ...
                            <div class="Social-NW-body">
                                ...
                                <br />
                                <a href="#"><i class="icon-calendar"></i> Liste des médecins</a>
                                <hr />
